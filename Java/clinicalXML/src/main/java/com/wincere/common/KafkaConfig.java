...
public class KafkaConfig {
	public void createtopic(String topicName){
		...
		//ZkClient zkClient = new ZkClient("172.16.1.151:2181",sessionTimeoutMs,connectionTimeoutMs, ZKStringSerializer$.MODULE$);
	...
	public  Producer<String, String> SetProducerProperties() {
		...
		props.put("metadata.broker.list", "172.16.1.83:9092,172.16.1.162:9092");
