...
public class YARNSubmit {
	public static void main(String[] args) throws InterruptedException,
		...
		String[] args1 = {
				"--jar",
				"/home/himanshu/Projects/Spark_1.2.0/Java/SqlTransformation/target/SqlTransformations_120-1.0-jar-with-dependencies.jar",
				"--class", "com.wincere.analytics.SparkApplicationMaster" };
